...
$jobs = [
    [
     ...
     "timeStart" => "январь 2015 -",
     "timeEnd" => " по н.в.",
     "duty" => "Разработка приложений на  HTML, CSS и JavaScript в клиенте"
    ],
    [
     "name" => "Веб разработчик",
     "timeStart" => "март 2012 - ",
     "timeEnd" => " декабрь 2014",
     "duty" => " Разработка и обслуживание серверной части веб-приложений PHP,                        Python, Node.js"
    ],
    [
     "name" => "Графический дизайнер",
     "timeStart" => "июнь 2010 - ",
     "timeEnd" => " март 2012",
     "duty" => "Разработка элементов графики и изображений, оформление веб-ресурсов,                 создание фирменных стилей брендов и тд."
    ]
];
?>
        ...
        <?php for($i = 0; $i < count($jobs); $i++): ?>
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal">
              ...
              <?php echo $jobs[$i]["timeStart"];?>
              <?php if($i == 0): ?>
                <span class="w3-tag w3-teal w3-round">
                  <?php echo $jobs[$i]["timeEnd"];?></span>
              <?php else: ?>
                <?php echo $jobs[$i]["timeEnd"];?>
              <?php endif; ?>
            </h6>
            <p><?php echo $jobs[$i]["duty"];?></p>
            <hr>
          </div>
        <?php endfor; ?>
      </div>
